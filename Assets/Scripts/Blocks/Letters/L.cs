...
public class L : Block
{
    ...
    protected override void Start()
    {
        ...
        letter = (GameObject)Resources.Load("prefabs/l", typeof(GameObject));
    }
    ...
    protected override void OnMouseUp()
    {
        ...
        {
            transform.position = ReplaceBlocks(transform.position.x, transform.position.y, initialPosition.x, initialPosition.y, 4.391f, -1.88f);
        }
