...
public class V : Block
{
    ...
    protected override void Start()
    {
        ...
        letter = (GameObject)Resources.Load("prefabs/v", typeof(GameObject));
    }
