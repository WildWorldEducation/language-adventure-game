...
public class C : Block
{
    ...
    protected override void Start()
    {
        ...
        letter = (GameObject)Resources.Load("prefabs/c", typeof(GameObject));
    }
