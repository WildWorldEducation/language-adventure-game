...
public class H : Block
{
    ...
    protected override void Start()
    {
        ...
        letter = (GameObject)Resources.Load("prefabs/h", typeof(GameObject));
    }
