...
public class M : Block
{
    ...
    protected override void OnMouseUp()
    {
        ...
        {
            transform.position = ReplaceBlocks(transform.position.x, transform.position.y, initialPosition.x, initialPosition.y, 4.391f, -3.132f);
        }
