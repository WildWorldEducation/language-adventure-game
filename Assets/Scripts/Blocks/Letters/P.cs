...
public class P : Block
{
    ...
    protected override void Start()
    {
        ...
        letter = (GameObject)Resources.Load("prefabs/p", typeof(GameObject));
    }
    ...
    protected override void OnMouseUp()
    {
        ...
        {
            transform.position = ReplaceBlocks(transform.position.x, transform.position.y, initialPosition.x, initialPosition.y, 1.872f, -4.379f);
        }
